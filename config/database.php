...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv_nibss' => [
            'driver' => 'sqlsrv',
            'url' => env('NIBSS_DATABASE_URL'),
            'host' => env('NIBSS_DB_HOST', 'localhost'),
            'port' => env('NIBSS_DB_PORT', '1433'),
            'database' => env('NIBSS_DB_DATABASE', 'forge'),
            'username' => env('NIBSS_DB_USERNAME', 'forge'),
            'password' => env('NIBSS_DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            // 'encrypt' => env('DB_ENCRYPT', 'yes'),
